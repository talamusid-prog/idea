  ...
  const t = (key: string): string => {
    const translations = {
      id: {
        ...
        'about.mission.item1': 'Menciptakan Media-media Promosi Berkualitas untuk Kebutuhan Bisnis para Pengusaha di kota Makassar',
        'about.mission.item2': 'Memberikan Pelayanan Terbaik dan Professional Kepada Pelanggan dan Mitra Kerja',
        'about.mission.item3': 'Mengembangkan Kemitraan yang saling mendukung, Menguntungkan dan Menjaga',
      ...
      en: {
        ...
        'about.mission.item1': 'Creating Quality Promotional Media for Business Needs of Entrepreneurs in Makassar City',
        'about.mission.item2': 'Providing the Best and Professional Service to Customers and Business Partners',
        'about.mission.item3': 'Developing mutually supportive, Beneficial and Sustainable Partnerships',
